...
const patientCards = [
  ...
  {
    title: "Medicininė suvestinė",
    description:
      "Paruošta vieta diagnozės santraukai, tyrimų rezultatams ir išrašymo pastaboms.",
  },
  {
    title: "Registracijos būsena",
    description:
      "Vėliau čia bus galima matyti, ar pateiktos formos laukia peržiūros, yra patvirtintos ar atnaujintos.",
  },
];
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            ...
            <h1 className="display-font mt-3 text-4xl font-semibold sm:text-5xl">
              Paciento portalo peržiūra
            </h1>
            <p className="mt-4 text-base leading-7 text-foreground/72 sm:text-lg">
              Šis maršrutas atvertas testavimui be autentifikacijos ir yra
              paruoštas plėstis į pilną pacientui skirtą aplinką.
            </p>
          </div>
